  ...
  <div id="wrap">
      ...
      <div class="sidebar-nav nav-collapse collapse">
        ...
        <div class="accordion" id="accordion2">
          ...
          <div class="accordion-group">
            ...
            <div id="collapse2" class="accordion-body collapse">
              <div class="accordion-inner">
                <a class="accordion-toggle active" href="user_service.jsp"><i class="icon-star"></i> 个人信息概览</a>
              ...
              <div class="widget-forms clearfix">
                <form class="form-horizontal">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <img class="gym-client-photo" alt="" src="assets/img/odinn.jpg">                      
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">                                          
                      <label id="user-info-id" class="gym-user-info"></label>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">                                          
                      <label id="user-info-username" class="gym-user-info"></label>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">                                          
                      <label id="user-info-name" class="gym-user-info"></label>
                    </div>
                  </div>
                  ...
                  <!-- <div class="control-group">
                    ...
                    <div class="controls">                                          
                      <label id="user-info-sex" class="gym-user-info"></label>
                    </div>
                  </div> -->
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">                                          
                      <label id="user-info-joindate" class="gym-user-info"></label>
                    </div>
                  </div>
                </form>
              </div>
	...
	<script type="text/javascript">
		window.onload = function(){
			...
			$.ajax({
				type:"post",//请求方式
				url:"<%=request.getContextPath()%>/servlet/GetFront",//发送请求地址
				data:{//发送给数据库的数据
					id:tar_id					
				},
			   //请求成功后的回调函数有两个参数
				success:function(data, status){
			    	...
			    	if (rd.length > 0){
			    		...
			    		$("#user-info-username").html(rd[0].username);
