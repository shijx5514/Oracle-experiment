  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="sidebar-nav nav-collapse collapse">
        ...
        <div class="accordion" id="accordion2">
          ...
          <div class="accordion-group">
            <div class="accordion-heading">
              <a class="accordion-toggle b_9FDDF6  active" href="attendance_record_service.jsp"><i class="icon-bullhorn"></i> <span>会员考勤</span></a>
            </div>
          </div>
	...
	window.onload = function(){
		var login_status = <%=session.getAttribute("status")%>;
	 	...
	 	$.ajax({
			type:"post",//请求方式
			url:"<%=request.getContextPath()%>/servlet/GetRecord",//发送请求地址
			data:{//发送给数据库的数据
				id:"*"					
			},
		   //请求成功后的回调函数有两个参数
		    	...
		    	if (rd.length > 0){
		    		for (var i=0; i<rd.length; i++){
		    			htmlStr += "<li>"
			                ...
			                +     "<div class=\"date\">"+rd[i].record_time+"</div>"				                     
			                +   "</li>";
