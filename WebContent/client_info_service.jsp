...
<html lang="en">
  ...
  <body>
          ...
          <div class="accordion-group">
            ...
            <div id="collapse1" class="accordion-body collapse">
              <div class="accordion-inner">
                ...
                <a class="accordion-toggle  active" href="client_info_service.jsp"><i class="icon-list-alt"></i> 会员信息概览</a>
                ...
                <div class="widget-tickets widget-tickets-large clearfix">
                  <ul id="client-info-table">
                    <li class="">
                      ...
                      性别：男  年龄：20  入会日期：2016-10-10  会员截止日期：2018-10-10                      
                    </li>
                    <li class="">
                      <img src="assets/img/avatars/11.jpg" class="avatar"/>
                      <h5>吕燕  ID：A057322</h5>
                      性别：女  年龄：19  入会日期：2016-9-28  会员截止日期：2018-9-28
			...
			success:function(data, status){
		    	...
		    	if (rd.length > 0){
		    		for (var i=0; i<rd.length; i++){
		    			htmlStr += "<li onclick=\"go_single_info("+rd[i].id+")\">"
					            +     "<img src=\"assets/img/gallery/2.jpg\" class=\"avatar\"/>"
					            +	  "<input type=\"text\" value="+rd[i].id+" style=\"display:none;\"/>"
				                +     "<h5>" +rd[i].name+ "  ID："+ rd[i].id +"</h5>"
				                +      		"性别："+rd[i].sex+"  年龄："+rd[i].age+"  入会日期："+rd[i].joindate+"  会员截止日期："+rd[i].expiredate                      
				                +   "</li>";
    ...
    function go_single_info(tar_id){
    	location.href = "single_client_info_service.jsp?searchid=" + tar_id; 
    }
