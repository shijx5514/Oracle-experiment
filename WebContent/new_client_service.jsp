  ...
  <div id="wrap">
          ...
          <div class="accordion-group">
            ...
            <div id="collapse1" class="accordion-body collapse">
              <div class="accordion-inner">
                <a class="accordion-toggle active" href="new_client_service.jsp"><i class="icon-star"></i> 添加新会员</a>
        ...
        <div class="row-fluid">
          <div class="widget widget-padding span12">
              ...
              <div class="widget-forms clearfix">
                <form class="form-horizontal">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <img class="gym-client-photo" alt="" src="">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-name" class="span2" type="text" placeholder="">
                      <span class="help-inline" style="color:red;">*</span>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-age" class="span1" type="text" placeholder="">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-ic" class="span3" type="text" placeholder="">
                      <span class="help-inline" style="color:red;">*</span>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-phone" class="span3" type="text" placeholder="">
                      <span class="help-inline" style="color:red;">*</span>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-height" class="span1" type="text" placeholder="">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-weight" class="span1" type="text" placeholder="">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="user-info-fatbate" class="span1" type="text" placeholder="">
                  ...
                  <div class="control-group">
                    <label class="control-label">入会日期</label>
                      <div class="controls">
                        <div class="input-append date span3 datepicker datepicker-basic" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
                          <input id="user-info-joindate" size="16" type="text" value="">
                  ...
                  <div class="control-group">
                    <label class="control-label">会员截止日期</label>
                      <div class="controls">
                        <div class="input-append date span3 datepicker datepicker-basic" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
                          <input id="user-info-expiredate" size="16" type="text" value="">
                          <span class="add-on"><i class="icon-th"></i></span>                          
                        </div>
                      <span class="help-inline" style="color:red;">*</span>
                      </div>
            ...
            <div class="widget-footer">
               <button onclick="save()" ="btn btn-primary" type="submit">保存</button>
	...
	<script type="text/javascript">
		function save(){
			...
			var joindate = $("#user-info-joindate").val();
    		var expiredate = $("#user-info-expiredate").val();
			...
			if (joindate == ""){
				alert("请填写必要信息！");
				$("#user-info-joindate").focus();
				return false;
			}
			if (expiredate == ""){
				alert("请填写必要信息！");
				$("#user-info-expiredate").focus();
				return false;
			}
